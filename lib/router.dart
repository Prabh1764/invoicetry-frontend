...
final routerProvider = Provider<GoRouter>((ref) {
  try {
    ...
    // DON'T try to read or watch authStateProvider during initialization
    // This causes the minified:WR error
    // Instead, let the listener update the state when it's ready
    ...
    // DON'T try to read authStateProvider here - it causes minified:WR error
    // The listener will update _globalAuthNotifier when auth state is ready
    // Start with null - router will redirect to login if needed
    debugPrint('🔧 [ROUTER] Starting router with null auth state - listener will update when ready');
